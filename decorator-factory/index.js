...
var OnePieceCharacter = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            _greet_decorators = [logWithPrefix('One piece logger')];
...
function logWithPrefix(prefix) {
    return function actulDecorator(method, context) {
        function replaceMethod() {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            console.log("".concat(prefix, ": method start"));
            var result = method.call(this, args);
            console.log("".concat(prefix, ": method end"));
            return result;
        }
